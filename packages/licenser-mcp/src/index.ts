...
tool('licenser_issue_license',
  'Issue a new license. Returns the plaintext key ONCE — surface it to the operator; it is only stored hashed-of-record as key_prefix.', {
